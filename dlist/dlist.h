...
/******************************************************************************
* Function Description: return a beginning of a Dlist DS
...
* Notes: last node in Dlist.

* Time Complexity: O(1)
*******************************************************************************/
iterator_ty DlistEnd(const dlist_ty *dDlist);

/******************************************************************************
* Function Description: return the next node in a Dlist
* Arguments: iterator.
* Return value: iterator of the next node in Dlist.
* Notes: iterator of the next node in Dlist.
